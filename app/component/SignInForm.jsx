...
const SignInForm = () => {
  return (
    <div className="col-md-5 form-container">
      <Link href={"./signIn"} className="me-4 signIn">
        Sign In
      </Link>
      ...
      <form>
        ...
        />
        <div className="form-check d-flex justify-content-between align-items-center mt-4 ">
          <div>
            <input
              type="checkbox"
          ...
          <Link href="#" className="d-block text-right text-decoration-none">
